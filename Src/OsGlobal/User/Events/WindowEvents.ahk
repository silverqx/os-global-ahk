...
GroupAdd('FullscreenGroupOnOpenAlt', '^CS RIN - Steam Underground • Index page(?:$| - .+) ' . WinTitleChromeMain)
...
GroupAdd('FullscreenGroupOnOpenAlt', '^Google (Account|Calendar|Drive|Password Manager|Photos)$ ' . WinTitleChromeMain)
GroupAdd('FullscreenGroupOnOpenAlt', '^Grokipedia(?:$| - .+) ' . WinTitleChromeMain)
; GroupAdd('FullscreenGroupOnOpenAlt', '( - Notepad\+\+)$ ahk_class Notepad\+\+ ahk_exe notepad\+\+.exe')
